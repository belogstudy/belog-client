          ...
          <div className="bg-white flex flex-col items-start mt-12 mb-10">
            <p
              className={`text-xl mb-2 ${
                pActive === "name" ? "text-velogauthgreen-100" : ""
              }`}
            >
              이름
            </p>
            ...
            <p
              className={`text-xl mb-2 ${
                pActive === "password" ? "text-velogauthgreen-100" : ""
              }`}
            >
              비밀번호
            </p>
            ...
            <p
              className={`text-xl mb-2 ${
                pActive === "email" ? "text-velogauthgreen-100" : ""
              }`}
            >
              이메일
            </p>
            ...
            <p
              className={`text-xl mb-2 ${
                pActive === "intro" ? "text-velogauthgreen-100" : ""
              }`}
            >
              한 줄 소개
            </p>
